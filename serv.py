...
def sender(conn, conn1, q):
    ...
    sendata += str(engine.units[q].health) + ',' + 'red health/'
    sendata += str(engine.units[q+1].health) + ',' + 'blue health/'
    if engine.units[q].health != 0:
        ...
        a1, b1, c1, d1 = int(engine.win_height / len(engine.maps[q//2]) * engine.units[q].x)+5, int(engine.win_height / len(engine.maps[q//2][0]) * engine.units[q].y) + engine.units[q].height // 2 + 2, engine.UnitRed.width * engine.units[q].health // 5, 6
    ...
    if engine.units[q+1].health != 0:
        ...
        a1, b1, c1, d1 = int(engine.win_height / len(engine.maps[q//2]) * engine.units[q+1].x)+5, int(engine.win_height / len(engine.maps[q//2][0]) * engine.units[q+1].y) + engine.units[q+1].height // 2 + 2, engine.UnitBlue.width * engine.units[q+1].health // 5, 6
